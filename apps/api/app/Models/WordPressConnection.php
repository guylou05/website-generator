...
class WordPressConnection extends Model
{
    ...
    protected $fillable = ['project_id', 'site_url', 'username', 'encrypted_application_password', 'status', 'wordpress_version', 'elementor_version', 'connector_version', 'last_verified_at', 'last_error'];
