...
class DeploymentPlan extends Model
{
    ...
    protected function casts(): array { return ['snapshot' => 'array', 'changes' => 'array', 'statistics' => 'array', 'warnings' => 'array', 'estimated_seconds' => 'integer']; }
    public function project(): BelongsTo { return $this->belongsTo(Project::class); }
    public function websiteRevision(): BelongsTo { return $this->belongsTo(WebsiteRevision::class); }
    public function wordpressConnection(): BelongsTo { return $this->belongsTo(WordPressConnection::class); }
}
