...
class Project extends Model
{
    ...
    protected $fillable = ['name', 'slug', 'status', 'business_profile', 'brand_settings', 'organization_id', 'approved_revision_id', 'latest_revision_id', 'default_wordpress_connection_id', 'last_deployment_id'];
