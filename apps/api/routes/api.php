...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('tenant.access')->group(function () {
        ...
        Route::post('/media/uploads', [MediaController::class, 'initiate']);
        Route::post('/media/uploads/{mediaAsset}/complete', [MediaController::class, 'complete']);
        Route::post('/media/uploads/{mediaAsset}/abort', [MediaController::class, 'abort']);
        Route::get('/media/{mediaAsset}', [MediaController::class, 'show']);
        Route::patch('/media/{mediaAsset}', [MediaController::class, 'update']);
        Route::delete('/media/{mediaAsset}', [MediaController::class, 'destroy']);
        Route::post('/media/{mediaAsset}/restore', [MediaController::class, 'restore']);
        Route::get('/media/{mediaAsset}/variants', [MediaController::class, 'variants']);
        Route::post('/media/{mediaAsset}/reprocess', [MediaController::class, 'reprocess']);
        Route::get('/projects/{project}/image-generations', [ImageGenerationController::class, 'index']);
        Route::post('/projects/{project}/image-generations', [ImageGenerationController::class, 'store']);
