...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('tenant.access')->group(function () {
        ...
        Route::get('/wordpress-connections', [WordPressConnectionController::class, 'index']);
        Route::post('/wordpress-connections', [WordPressConnectionController::class, 'store'])->middleware('verified.email');
        Route::get('/projects/{project}/wordpress-connections', [WordPressConnectionController::class, 'projectIndex']);
        Route::post('/projects/{project}/wordpress-connections', [WordPressConnectionController::class, 'projectStore'])->middleware('verified.email');
        ...
        Route::post('/wordpress-connections/{connection}/test', [WordPressConnectionController::class, 'test'])->middleware('verified.email');
...
Route::middleware('internal.worker')->prefix('internal')->group(function () {
    ...
    Route::post('/deployments/{deployment}/running', [InternalJobController::class, 'deploymentRunning']);
});
