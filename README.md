...
The authenticated customer dashboard, profile, organization settings, empty states, and supported route matrix are documented in [`docs/dashboard-completion.md`](docs/dashboard-completion.md).
